...
def scrape_foxnews():
    ...
    link_tags = soup.find_all('div', class_='m')
    ...
    for i in article_urls:
        ...
        try:
            ...
            for paragraph in article_body_div.find_all('p'):
                if paragraph.find_parent('div', class_='contain'):
                    continue
                elif paragraph.find('strong'):
                    continue
                elif paragraph.find_parent('div', class_='article-meta'):
                    continue
