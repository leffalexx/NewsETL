...
def scrape_pbsnewshour():
    ...
    link_tags = soup.find_all('a', class_='card-sm__title')

    article_urls = []
    for link_tag in link_tags:
        article_urls.append(link_tag.get('href'))
    ...
    for i in article_urls:
        ...
        paragraphs = []
        try:
            article_body_div = soup.find('div', class_='body-text')
    ...
    pbsnewshour_articles = []
    for i in range(len(article_urls)):
        pbsnewshour_articles.append({
            "source": url,
            "url": article_urls[i],
            "title": heading[i],
            "content": article[i]
    ...
    for data in pbsnewshour_articles:
